  ...
  return (
    <div className="home-page">
      <div className="about-us-container">
        ...
        <p>
          Our story began with a simple idea: to create authentic, delicious
          pizzas that bring people together. From our signature crispy crusts to
          our rich, flavorful sauces, each pizza is a testament to our
